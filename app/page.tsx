...
import { Folder, File, Upload, FolderPlus, MoreVertical, ChevronRight, ArrowLeft } from "lucide-react"
...
export default function Home() {
  ...
  const loadItems = async () => {
    ...
    try {
      ...
      const folderItems: FileItem[] = Array.from(folderPaths).map((folderName) => ({
        name: folderName,
  ...
  const deleteFolder = async (folderPath: string) => {
    ...
    const folderDeletePromises = result.prefixes.map((subFolderRef) => deleteFolder(subFolderRef.fullPath))
