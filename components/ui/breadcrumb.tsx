...
>(({ asChild, className, ...props }, ref) => {
  ...
  return <Comp ref={ref} className={cn("transition-colors duration-200 hover:text-black", className)} {...props} />
})
...
const BreadcrumbEllipsis = ({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) => (
  <span
    ...
    {...props}
  >
    <span className="flex h-1 w-1 rounded-full bg-muted-foreground/60 ring-1 ring-muted-foreground/60">
